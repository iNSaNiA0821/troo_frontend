                        ...
                        <div className="middle-wrap">
                            <div className="card w-100 border-white bg-white shadow-xs p-0 mb-4">
                                <div className="card-body p-4 w-100 bg-black border-0 d-flex rounded-3">
                                    <Link to="/wallet" className="d-inline-block mt-2"><i className="ti-arrow-left font-sm text-medium"></i></Link>
                                    <h4 className="font-xs text-medium fw-600 ms-4 mb-0 mt-2">Payment Method</h4>
                                </div>
